    ...
    return (
        <div className={styles.todos}>
            <div className={styles.btnBox}>
                <button className={cn(styles.btn, { [styles.btnActive]: filterStatus === 'all' })}
                    onClick={() => setFilterStatus('all')}>All</button>
                <button className={cn(styles.btn, { [styles.btnActive]: filterStatus === 'done' })}
                    onClick={() => setFilterStatus('done')}>Done</button>
                <button className={cn(styles.btn, { [styles.btnActive]: filterStatus === 'inProgress' })}
                    onClick={() => setFilterStatus('inProgress')}>In progress</button>
            </div>
